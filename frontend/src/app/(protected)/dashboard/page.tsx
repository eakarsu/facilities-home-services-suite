...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Facilities Home Services Dashboard"
      subtitle="One merged facilities home services view for Work Orders, Customers, Properties, Scheduling, Technicians, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared facilities home services jobs into one surface. Work Orders, Customers, Properties, Scheduling, Technicians, Estimates, documents, audit, and AI are presented as platform features.</div>
