export const AUTH_COOKIE = 'facilities_home_services_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@facilities-home.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@facilities-home.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@facilities-home.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
