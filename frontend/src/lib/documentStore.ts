...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Work Orders Packet', type: 'Work Orders', owner: 'Operations Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Customers Review Bundle', type: 'Customers', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Properties Evidence Set', type: 'Properties', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
