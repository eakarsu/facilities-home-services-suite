...
const entitySeeds = [
  ['work-orders', 'Work Orders Records', 'Work Orders priority queue', 'Open', 'Work Orders exception list', 'Operations Lead', '$0'],
  ['customers', 'Customers Records', 'Customers priority queue', 'Review', 'Customers exception list', 'Operations Lead', '$0'],
  ['properties', 'Properties Records', 'Properties priority queue', 'Action needed', 'Properties exception list', 'Operations Lead', '$0'],
  ['scheduling', 'Scheduling Records', 'Scheduling priority queue', 'Open', 'Scheduling exception list', 'Operations Lead', '$0'],
  ['technicians', 'Technicians Records', 'Technicians priority queue', 'Review', 'Technicians exception list', 'Operations Lead', '$0'],
  ['estimates', 'Estimates Records', 'Estimates priority queue', 'Action needed', 'Estimates exception list', 'Operations Lead', '$0'],
  ['inspections', 'Inspections Records', 'Inspections priority queue', 'Open', 'Inspections exception list', 'Operations Lead', '$0'],
  ['inventory', 'Inventory Records', 'Inventory priority queue', 'Review', 'Inventory exception list', 'Operations Lead', '$0'],
  ['invoices', 'Invoices Records', 'Invoices priority queue', 'Action needed', 'Invoices exception list', 'Governance Lead', '$0'],
  ['quality', 'Quality Records', 'Quality priority queue', 'Open', 'Quality exception list', 'Governance Lead', '$0'],
  ['routes', 'Routes Records', 'Routes priority queue', 'Review', 'Routes exception list', 'Intelligence Layer Lead', '$0'],
