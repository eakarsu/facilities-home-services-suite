...
const featureSeeds = [
  ['work-orders', 'Work Orders', 'Work Orders operating queue', 'Operations Lead', 'Review and assign next action'],
  ['customers', 'Customers', 'Customers operating queue', 'Operations Lead', 'Review and assign next action'],
  ['properties', 'Properties', 'Properties operating queue', 'Operations Lead', 'Review and assign next action'],
  ['scheduling', 'Scheduling', 'Scheduling operating queue', 'Operations Lead', 'Review and assign next action'],
  ['technicians', 'Technicians', 'Technicians operating queue', 'Operations Lead', 'Review and assign next action'],
  ['estimates', 'Estimates', 'Estimates operating queue', 'Operations Lead', 'Review and assign next action'],
  ['inspections', 'Inspections', 'Inspections operating queue', 'Operations Lead', 'Review and assign next action'],
  ['inventory', 'Inventory', 'Inventory operating queue', 'Operations Lead', 'Review and assign next action'],
  ['invoices', 'Invoices', 'Invoices operating queue', 'Governance Lead', 'Review and assign next action'],
  ['quality', 'Quality', 'Quality operating queue', 'Governance Lead', 'Review and assign next action'],
  ['routes', 'Routes', 'Routes operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
