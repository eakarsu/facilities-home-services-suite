...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Work Orders alert', detail: 'Work Orders queue needs review.', read: false },
  { id: 'note-2', title: 'Customers approval due', detail: 'Customers exception list needs approval.', read: false },
  { id: 'note-3', title: 'Properties updated', detail: 'Properties operating queue was refreshed.', read: true },
];
