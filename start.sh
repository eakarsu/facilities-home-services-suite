...
PORT="${PORT:-3820}"
DB_NAME="${PGDATABASE:-facilities_home_services_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Facilities Home Services Suite"
echo "======================================="
echo
...
echo "Starting facilities home services suite frontend on http://localhost:$PORT"
echo "Login: admin@facilities-home.local / admin123"
